...
- After recompile NAMD with default HPC-X MPI and also with cuda available version, the jobs worked correctly up to 4 nodes and 192 cpus per node with 4 gpus per node.
